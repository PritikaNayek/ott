...
<body>
    <section class="vh-100">
            ...
            <div class="card text-black" style="background-image: linear-gradient(to right,#b671bc, #59cbc7, #433378)">
                <div class="card-body p-md-5">
                    ...
                    <input type="submit" value="Register">
                        ...
                        <div class="col-md-20 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">
                            ...
                            <img src="back_side.jpeg" height="300" style="border-radius: 45px" class=" img-fluid" alt="Sample image">
